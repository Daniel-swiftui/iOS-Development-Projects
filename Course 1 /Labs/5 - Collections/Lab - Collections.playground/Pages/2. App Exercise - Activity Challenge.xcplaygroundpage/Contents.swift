 ...
 */
let walkingChallengeList: [String] = ["Walk 3 miles", "Walk 3 times a week "]
let runningChallengeList: [String] = ["Run 3 miles", "Run 3 times a week"]
...
var challenges = [walkingChallengeList, runningChallengeList]
