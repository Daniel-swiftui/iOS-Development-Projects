...
for indiviualMovements in movements {
    print("\(indiviualMovements)")
}
...
for averageMovementHeartRates in movementHeartRates {
    print("Your average heart rate for \(averageMovementHeartRates.key) is \(averageMovementHeartRates.value)")
}
