...
func pacing(currentDistance : Double, totalDistance : Double, currentTime : Double, goalTime : Double) {
    var onPace = (currentDistance < totalDistance) && (currentTime < goalTime)
    
    onPace ? print("Keep it up!") : print("You've got to push it just a bit harder!")
}
pacing(currentDistance: 5, totalDistance: 5, currentTime: 4, goalTime: 5)
/*:
