...
print(forwards(name1: "Daniel", name2: "David"))
...
let names = ["Daniel","David","Ema","Amy"]
let sortedCollections1 = names.sorted(by: forwards(name1:name2:))
...
let forward: (String,String) -> Bool = {(name1, name2) -> Bool in
    return name1 < name2
}
let sortedCollection2 = names.sorted(by: forward)
...
let sortedCollection3 = names.sorted(by: forward)
