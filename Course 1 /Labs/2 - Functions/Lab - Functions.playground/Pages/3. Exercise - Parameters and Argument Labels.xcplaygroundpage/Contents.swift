...
introduction(name: "Jenney", home: "California", age: 32)
//:  Write a function called `almostAddition` that takes two `Int` arguments. The first argument should not require an argument label. The function should add the two arguments together, subtract 2, then print the result. Call the function and observe the printout.
func almostAddition(_ firstNumber : Int, to secondNumber : Int) -> Int {
    
    return (firstNumber + secondNumber) - 2
}
print(almostAddition(6,to: 6))

/* Also could do
let result = almostAddition(6,to: 6)
print(result)*/
//:  Write a function called `multiply` that takes two `Double` arguments. The function should multiply the two arguments and print the result. The first argument should not require a label, and the second argument should have an external label, `by`, that differs from the internal label. Call the function and observe the printout.

func multiply(_ firstDouble : Double,by secondDouble : Double) -> Double {
    return firstDouble * secondDouble
}
print(multiply(2,by: 2.6))
/*:
