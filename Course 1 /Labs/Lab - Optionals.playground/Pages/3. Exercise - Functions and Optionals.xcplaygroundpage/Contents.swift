...
func checkAge(usersAge: String) -> Int? {
    if let age = Int(usersAge) {
        if age >= 18 {
            print("Welcome!")
        }else {
...
checkAge(usersAge: userInputAge)
...
func purchaseItem(item: String) -> Double {
...
let firstPurchase = purchaseItem(item: "Chips")
print(firstPurchase)
/*:
