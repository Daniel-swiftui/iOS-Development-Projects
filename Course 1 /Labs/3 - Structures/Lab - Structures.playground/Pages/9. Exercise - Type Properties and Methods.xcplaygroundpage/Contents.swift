...
struct User {
    ...
    static var currentUser = User(userName: "Daniel", email: "daniel@gmail.com", age: 29)
 ...
 */
User.logIn(user: User(userName: "Daniel", email: "jeff@gmail.com", age: 25))
// not sure if I understood this correctly
print("\(User.currentUser) user has logged in.")
/*:
