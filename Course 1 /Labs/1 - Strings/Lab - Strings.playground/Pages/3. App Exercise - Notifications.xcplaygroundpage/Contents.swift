...
let lastName = "Umpierrez"
let fullName = firstName + " " + lastName
print(fullName)
// not sure if this is correct or if it was wanting me to make it so there is a space between the first and last names.
/*:
 ...
 */
let previousBest = 14392//Is there a way to print this out with a comma?
// Yes, look into: NumberFormatter (look at "grouping?")
let newBest = 15125
let congratulations = "Congratulations. \(firstName)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
