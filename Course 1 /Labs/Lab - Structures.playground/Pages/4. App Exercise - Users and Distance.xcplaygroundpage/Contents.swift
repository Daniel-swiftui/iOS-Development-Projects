...
var daniel = User(name: "Daniel", age: 29, height: 6, weight: 238, activityLevel: 6)

print("My name is \(daniel.name) I am \(daniel.age) years old. I am \(daniel.height) ft tall and weigh \(daniel.weight)Lbs. I would say my activity level is a \(daniel.activityLevel) out of 10.")
/*:
...
var kilometers = Distance(feet: 5249.344)
