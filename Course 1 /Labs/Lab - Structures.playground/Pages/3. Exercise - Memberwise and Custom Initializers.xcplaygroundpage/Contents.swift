...
let favoriteBook = Book(title: "Harry Potter and the sorcerers stone", author: "J.K. Rowling", pages: 320, price: 7.14)
print("My favorite book is \(favoriteBook.title). The author is \(favoriteBook.author). It has \(favoriteBook.pages) pages and it costs \(favoriteBook.price)")
/*:
...
var x = Height(heightInInches: 6)
print(x.heightInInches)
print(x.heightInCentimeters)
