...
for (index, everyOtherLetter) in alphabet.enumerated() {
    if !index.isMultiple(of: 2){
        continue
    }
    print(everyOtherLetter)
}
...
let stateAndCapitals: [String: String] = [ "Utah": "Salt lake City", "North Carolina": "Raleigh", "California": "Sacramento"]

for (states, capitals) in stateAndCapitals {
    
    print("The capital of \(states) is \(capitals)")
