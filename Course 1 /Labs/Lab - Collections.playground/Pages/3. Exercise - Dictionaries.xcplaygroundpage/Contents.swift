...
daysInMonth.updateValue(30, forKey: "April")
print(daysInMonth)
...
var shapesArray: [String: [String]] = ["Shapes": ["square", "triangle", "circle"]]
var colorsArray: [String: [String]] = ["Colors": ["blue", "red", "yellow"]]
print(shapesArray)
print(colorsArray)
...
if let lastColor = colorsArray["Colors"] {
    print(lastColor[2])
}
